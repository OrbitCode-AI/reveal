    ...
    <Slide isNested={isNested} isVertical>
      <section data-transition="concave" data-background="#0d1117">
        ...
        <pre style={{
          ...
          <code style={{ color: '#c9d1d9', fontSize: '0.65em', lineHeight: '1.5' }}>{codeExample1}</code>
        </pre>
        <p style={{ marginTop: '1em', fontSize: '0.7em', opacity: 0.7 }}>
          Code syntax highlighting powered by highlight.js
        </p>
        <aside className="notes">
          Code blocks support syntax highlighting via highlight.js plugin.
          You can also animate code with line-by-line reveals.
        </aside>
      </section>
      <section data-background="#0d1117">
        ...
        <pre style={{
          ...
          <code style={{ color: '#c9d1d9', fontSize: '0.6em', lineHeight: '1.5' }}>{codeExample2}</code>
        </pre>
        <p className="fragment" style={{ marginTop: '1em', color: '#7ee787' }}>
          Edit any slide file to see live updates!
        </p>
        <aside className="notes">
          Each slide is a separate component file for maintainability.
          OrbitCode provides live preview as you edit!
        </aside>
      </section>
    </Slide>
  )
