  ...
  return (
    <Slide isNested={isNested} isVertical>
      <section data-transition="convex">
        ...
        <p style={{ opacity: 0.7 }}>
          Use the <em>down arrow</em> to navigate ↓
        </p>
        <aside className="notes">
          Vertical slides let you organize content hierarchically. Great for diving deeper into
          subtopics without cluttering the main flow.
        </aside>
      </section>
      ...
      <section data-background="#1a1a2e">
        ...
        <p className="fragment">
          This is a <strong>fragment</strong> - it appears on click!
        </p>
        <aside className="notes">
          Click or press space/arrow to reveal the fragment. Fragments are perfect for building up
