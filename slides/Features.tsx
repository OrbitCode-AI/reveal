...
export function Features() {
    ...
    <>
      ...
      <section>
        ...
        <p>
          ...
          <a href="https://revealjs.com/markdown/">docs</a>.
        </p>
        <pre>
          <code className="hljs html">{`<section data-markdown>
  ## Markdown Support
  ...
  Write content using inline or external Markdown.
      ...
      <section>
        <h2>Lightbox</h2>
        <p>
          Turn any element into a <a href="https://revealjs.com/lightbox/">lightbox</a> using{' '}
        ...
        <div className="r-hstack" style={{ gap: '2rem', justifyContent: 'center' }}>
          <div>
            <pre style={{ fontSize: '12px', width: '100%' }}>
              <code className="html">{`<img src="image.png" data-preview-image="image.png">`}</code>
            </pre>
            <img
              src="https://static.slid.es/logo/v2/slides-symbol-1024x1024.png"
              height="100"
              data-preview-image
              alt="Slides logo preview example"
            />
          </div>
          <div>
            <pre style={{ fontSize: '12px', width: '100%' }}>
              <code className="html">{`<img src="video.png" data-preview-video="video.mp4">`}</code>
            </pre>
            <img
              src="https://static.slid.es/site/homepage/v1/homepage-video-editor.png"
              height="100"
              data-preview-video="https://static.slid.es/site/homepage/v1/homepage-video-editor.mp4"
              alt="Video editor preview example"
            />
          </div>
        </div>
      </section>
